...
public interface CustomerService {
	...
	Customer findByName(String nameCustomer);



//	Customer login(String nameCustomer, String password);

	Optional<Customer> checklogin(String nameCustomer, String password);
